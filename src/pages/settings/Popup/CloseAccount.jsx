...
import {closeCloseAccountPopup} from '../../../redux/actions/actions';
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.browncontainer}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerText}>Выйти из аккаунт</Text>
          <TouchableOpacity onPress={() => dispatch(closeCloseAccountPopup())}>
            <CloseIcon />
          </TouchableOpacity>
        </View>
        ...
        <View style={{alignItems: 'center', marginTop: 40}}>
          <TouchableOpacity
            onPress={() => dispatch(closeCloseAccountPopup())}
            style={styles.btn}>
        ...
        <View style={{marginTop: 15}}>
          <Button
            onpress={() => {
              dispatch(closeCloseAccountPopup());
            }}
            text={'Выйти'}
          />
        </View>
